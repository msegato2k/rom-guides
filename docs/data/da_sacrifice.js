          ...
          entries: [
            {
              ...
              light: true,
              icon_card: "24630",
              stat: '+5% AA DMG, +5% "Meteor Storm" proc on AA +3% with Pale Lord Card',
            },
            {
              name: "Pale Lord Card",
              light: true,
            ...
            { br: true },
            {
              ...
              icon_card: "24600",
              stat: "ASPD +20% (It can exceed the ASPD limit and does not stack), AA DMG +7.5%. When AGI is above 180, AA DMG +5%.",
            },
            {
              name: "Lord of Death Card",
              icon_card: "30048",
              stat: "When using melee attacks, have a chance (+8%) to inflict Stun, Curse, Silnce, Poison or Bleed on the target for 3 sec, Increasse Dmg to targets inflicted with Stun, Curse, Silence, Poison or Bleed by +20%, +5% with depo."
            },
          ],
        },
      ],
